...
def build_distribution() -> None:
    ...
    shutil.copy(f"{curr_path}/background.jpeg", f"{exe_fp}")
    shutil.copy(f"{curr_path}/loading_background.jpg", f"{exe_fp}")
    shutil.copy(f"{curr_path}/SWE 7903 - Spectrum Analyzer Tool - User Manual - Team 4.pdf", f"{exe_fp}")
